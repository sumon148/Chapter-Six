...
# to Bangladesh data: Census 2001 and HIES 2000
# Description: Poverty Estimation assuming Two-level model with homoskedastic (HM)
# and Heteroskedastic (HT) level-one errors but HM level-two errors
# ------------------------------------------------------------------------------
rm(list=ls(all=TRUE))
# ------------------------------------------------------------------------------
# Loading Packages
